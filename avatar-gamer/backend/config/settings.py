...
SECRET_KEY = 'django-insecure-p&eswf%j7#w2rfhn8@!=av*)ccxz1!@(i^sc%n=%fukj&%ydbl'
...
CSRF_TRUSTED_ORIGINS = ['http://localhost:8100', 'http://127.0.0.1:8100', 'http://192.168.1.81:8100', 'capacitor://localhost', "http://192.168.1.5:8100"]
